            ...
            >
              <p class="fst-italic">
                <b>
                  ...
                  this knowledge in daily life.</b
                >
              </p>
              <br />
              <p>
                The practice of Yoga can give a false impression of effort. For
                this reason, Yoga Knowhow desires to spread the knowledge needed
                for you to use all the tools accessible in this ancient
                discipline.
              </p>
              <p>
                we plan to continue working on asana’s (poses), mantras and
                meditation videos. We set up a toolbox with those pillars, in
                order to build a strong foundation, deeply anchored in your
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="titlepage">
                  ...
                  <span
                    >A Health Coach Helps Make Change Safer and Better for Your
                    Body</span
                  >
                </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="tow-box mrgn-top">
                      ...
                      <p>
                        I will help you understand why you have gained the
                        weight
                      </p>
                    </div>
                  </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-3 col-md-6 footer-contact">
              <h3 style="margin-top: 20px; font-size: 25px"><b>YogaBar</b></h3>
              <p>
