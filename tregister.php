...
<head>
  ...
  <title>Trainers Registration - YogaBar</title>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="active" href="tregister.php">Trainers</a></li>
  ...
  <main id="main" data-aos="fade-in">
    ...
    <div class="breadcrumbs">
      <div class="container" style="margin-top: 20px;">
        <h2>Register to contact with us.</h2>
                        ...
                        <div class="form-items">
                            ...
                            <form class="requires-validation" novalidate>
                               ...
                               <div class="col-md-12 form-outline mb-4">
                                ...
                                <input class="form-control" type="file" id="customFile" required>
                                    <div class="valid-feedback">You selected a file!</div>
                               ...
                               <div class="col-md-12 form-outline mb-4">
                                ...
                                <input class="form-control" type="password" minlength="8" name="password" placeholder="Password" required>
                                   
                                   <div class="invalid-feedback">Minimum 8 charcater</div>
                               </div>
