...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
     ...
     <section  >
        <div class="container py-3 h-60" style="margin-top: 30px;" >
                ...
                <div class="card-body p-5 text-center">
                  ...
                  <form action="#">
                      ...
                      <div class="form-outline form-black mb-4">
                        ...
                        <input type="password" id="typePasswordX" minlength="8" class="form-control form-control-lg" required/>
                      
                        
                      
        
                     <button class="btn btn-dark btn-lg px-5" type="submit" style="margin-top: 10px;" value="submit">Login</button>
                  </form> 
                  ...
                  <div>
                    <p class="mb-0">Don't have an account? <a href="#exampleModal" class="text-black-50 fw-bold" data-bs-toggle="modal" data-bs-target="#exampleModal">Sign Up</a>
                    </p>
                  </div>
      ...
      <div class="modal-body">
        <form class="requires-validation" novalidate>
          ...
          <div class="col-md-12 form-outline mb-4">
            ...
            <input class="form-control" type="text" name="name" pattern="[A-Za-z]{1,32}" placeholder="First Name" required>
          ...
          <div class="col-md-12 form-outline mb-4">
            ...
            <input class="form-control" type="text" name="name" pattern="[A-Za-z]{1,32}" placeholder="Last Name" required>
          ...
          <div class="col-md-12 form-outline mb-4">
            <label for="email">Email</label> 
              <input class="form-control" type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="E-mail Address" required>
